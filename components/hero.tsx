      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <span className="inline-flex items-center gap-3">
            Built for
            <span className="inline-flex items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full bg-[#FE3030]/10">
              <Handshake className="w-5 h-5 md:w-7 md:h-7 text-[#FE3030]" />
            </span>
            Brands
          </span>{" "}
          That Scale.
