  ...
  const steps = [
    {
      ...
      description:
        "We dive deep into your brand's goals, target audience, and competitive landscape to craft a strategy that aligns with your vision.",
    },
    {
      number: "02",
      title: "Creative Concepting",
      description:
        "Our team develops stunning, user-centric designs, brand concepts, and storyboards that capture your unique identity.",
    },
    {
      number: "03",
      title: "Production & Development",
      description:
        "We bring concepts to life, whether it's building performant websites, shooting high-quality video, or finalizing merch designs.",
    },
    {
      number: "04",
      title: "Review & Refinement",
      description:
        "Rigorous review ensures everything aligns with your brand standards before final delivery.",
    },
    {
      number: "05",
